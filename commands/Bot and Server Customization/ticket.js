module.exports = {
	...
	desc: ()=> "Before using this, you should run `hub!ticket config setup`. Use `hub!ticket post [channel]` or `hub!ticket bind [channel] [messageID]` to open the system for reactions and ticket creation. Users can have a total of 5 tickets open at once to prevent spam.",
