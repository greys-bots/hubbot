module.exports = {
	...
	execute: async (bot, msg, args)=>{
		...
		var scc = await bot.utils.addBanLog(bot, code, msg.guild.id, message.channel.id, message.id, banned);
...
module.exports.subcommands.notification = {
	help: ()=> "Sets the channel for ban notifications from a host server. For use with `hub!sync`",
